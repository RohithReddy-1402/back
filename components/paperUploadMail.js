...
<head>
    ...
    <title>Thank You - NIT KKR Previous Papers</title>
    ...
    <div style="padding: 20px 0; background-color: #f8fafc;">
        <div class="email-container">
            ...
            <div class="header">
                ...
                <div class="header-title">Contribution Received</div>
                <div class="header-subtitle">Thank You for Uploading!</div>
            </div>
            ...
            <div class="content">
                ...
                <div class="message">
                    Thank you for uploading a question paper to NIT KKR Previous Papers! Your contribution helps fellow students find the resources they need, and we truly appreciate you taking the time to share it with the community.
                </div>

                <div class="paper-container">
                    <div class="paper-label">Paper Uploaded</div>
                    <div class="paper-name">${paperName || 'Question Paper'}</div>
                    <div class="timestamp">Uploaded on: ${formattedTime}</div>
                </div>

                <div class="highlight">
                    <div class="highlight-text">
                        Your upload is now being reviewed and will be made available on the site shortly. We look forward to more of your contributions!
                    </div>
                </div>

                <div style="text-align: center;">
                    <a href="https://nitkkrpreviouspapers.vercel.app" class="verify-button">Visit the Site</a>
                </div>
            ...
            <div class="footer">
                <div class="footer-text">
                    ...
                    If you didn't upload this paper, please contact us.
